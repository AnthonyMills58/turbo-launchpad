...
export default function TokenDetailsView({
  ...
  const { writeContractAsync } = useWriteContract() // ✅ correctly extract the method
  ...
  try {
    ...
    // 🔄 Update the database with new on-chain data
  ...
  <div className="max-w-4xl mx-auto mt-6 p-6 bg-[#1b1e2b] rounded-lg shadow-lg text-white">
    ...
    <div className="flex flex-col sm:flex-row gap-6">
      ...
      <div className="flex-grow">
        ...
        {/* Creator Buy + Graduate below it, no border */}
