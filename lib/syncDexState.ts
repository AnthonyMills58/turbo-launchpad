  ...
  try {
    ...
    try {
      ...
      if (existingRows.length === 0) {
        ...
        // Get actual token order from the pair contract
        ...
        `, [token.id, chainId, pairAddress, actualToken0, actualToken1, wethAddress, estimatedDeploymentBlock, estimatedDeploymentBlock, estimatedDeploymentBlock - 1, 18, 18, 18])
